...
| 004  | Motion-dom projection authoritative (page-space, retire legacy FLIP) | P1         | L      | 003        | **YES — update** `docs/layout-animations`; shared-layout page as follow-up | IN PROGRESS — Steps 1-2 done (characterization + spike); gated at checkpoint before Step 3 |
