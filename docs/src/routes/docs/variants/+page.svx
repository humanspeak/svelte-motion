...
<script>
    import VariantsBasicExample from '$lib/examples/variants-basic/demos/Default.svelte'
    import Example from '$lib/components/general/Example.svelte'
    import VariantsPropagationExample from '$lib/examples/variants-propagation/demos/Default.svelte'
    import NotificationsStackExample from '$lib/examples/notifications-stack/demos/Default.svelte'
    ...
    if (seo) {
        ...
        seo.ogTitle = 'Variants'
        seo.ogTagline = 'Define named animation states for orchestrated transitions'
        seo.ogFeatures = ['Named States', 'Stagger Children', 'Propagation', 'Orchestration']
        seo.ogSlug = 'docs-variants'
    }
</script>
