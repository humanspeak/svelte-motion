...
<script>
  ...
  import AnimatePresenceExample from '$lib/examples/animate-presence/demos/Default.svelte'
  ...
  if (seo) {
      ...
      seo.ogTagline = 'Animate components when they enter and leave the DOM'
      seo.ogFeatures = ['Exit Animations', 'Enter Transitions', 'List Support', 'Conditional Rendering']
      seo.ogSlug = 'docs-animate-presence'
  }
</script>
