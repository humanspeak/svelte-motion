...
<script>
  ...
  import UseCycleExample from '$lib/examples/use-cycle/demos/Default.svelte';
  import { getSeoContext } from '$lib/components/contexts/Seo/Seo.context'

  const seo = getSeoContext()
  if (seo) {
      seo.title = 'useCycle | Docs | Svelte Motion'
      seo.description = 'Cycle through a series of values - perfect for toggling animation variants in Svelte. useCycle returns a $state-backed object with .current and .cycle.'
