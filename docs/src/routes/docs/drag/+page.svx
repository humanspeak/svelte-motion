...
<script>
  ...
  if (seo) {
      ...
      seo.ogTitle = 'Drag'
      seo.ogTagline = 'Physics-based dragging with constraints and momentum'
      seo.ogFeatures = ['Physics Momentum', 'Elastic Constraints', 'Touch Support', 'Gesture Callbacks']
      seo.ogSlug = 'docs-drag'
  }
</script>
