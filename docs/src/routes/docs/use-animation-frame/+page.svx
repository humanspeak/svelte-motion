...
<script>
  ...
  import UseAnimationFrameExample from '$lib/examples/use-animation-frame/demos/Default.svelte';
  ...
  if (seo) {
      ...
      seo.ogTagline = 'Run logic on every animation frame with delta timing'
      seo.ogFeatures = ['Delta Timing', 'Frame Callback', 'Elapsed Time', 'Smooth Animation']
      seo.ogSlug = 'docs-use-animation-frame'
  }
</script>
