---
title: API Reference
description: Exported TypeScript types, motion re-exports, SSR behavior, and other surface-area details that don't belong on a per-hook page.
---
...
<script>
  ...
  if (seo) {
      seo.title = 'API Reference | Docs | Svelte Motion'
      seo.description = "Reference for Svelte Motion's exported TypeScript types, motion package re-exports (animate, easing, math utilities), and SSR behavior."
      seo.ogTitle = 'API Reference'
      seo.ogTagline = 'Types, re-exports, and SSR behavior'
      seo.ogFeatures = ['TypeScript Types', 'Motion Re-exports', 'SSR Safe', 'Tree-shakeable']
