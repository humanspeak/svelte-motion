...
description: "Reactive Svelte 5 hook for the user's prefers-reduced-motion accessibility preference."
---

<script>
  import { useReducedMotion } from '@humanspeak/svelte-motion';
  import Example from '$lib/components/general/Example.svelte';
  import UseReducedMotionExample from '$lib/examples/use-reduced-motion/demos/Default.svelte';
  ...
  if (seo) {
      ...
      seo.ogSlug = 'docs-use-reduced-motion'
  }
</script>
...
<Example isSmall exampleUrl="/examples/use-reduced-motion">
