---
title: "styleString"
description: "A helper for creating CSS style strings with automatic unit handling."
---

<script>
  import Example from '$lib/components/general/Example.svelte';
  import StyleStringExample from '$lib/examples/style-string/demos/Default.svelte';
  import { getSeoContext } from '$lib/components/contexts/Seo/Seo.context'

  const seo = getSeoContext()
  if (seo) {
      seo.title = 'styleString | Docs | Svelte Motion'
      seo.description = 'A helper utility for creating reactive CSS style strings with automatic unit handling. Simplifies dynamic inline styles in Svelte components.'
      seo.ogTitle = 'Style String'
      seo.ogTagline = 'Animate inline style strings with motion components'
      seo.ogFeatures = ['Auto Units', 'Reactive CSS', 'Style Objects', 'Dynamic Inline']
      seo.ogSlug = 'docs-style-string'
  }
</script>
...
<Example isSmall exampleUrl="/examples/style-string">
  <StyleStringExample />
</Example>
