---
title: "useVelocity"
description: "Track the velocity of a motion value in units per second."
---
...
<script>
  ...
  if (seo) {
      ...
      seo.description = 'Track the velocity of a motion value in units per second. Returns a real motion-dom MotionValue with reactive .current reads in Svelte 5.'
      seo.ogTitle = 'useVelocity'
      seo.ogTagline = 'Track the velocity of a motion value'
      seo.ogFeatures = ['Velocity Tracking', 'Units Per Second', 'MotionValue', 'Composable']
      seo.ogSlug = 'docs-use-velocity'
  }
</script>
