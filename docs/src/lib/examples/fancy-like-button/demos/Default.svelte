<script lang="ts">
    ...
    const buttonBg = $derived(isLiked ? 'bg-red-500/50' : 'bg-[var(--brut-ink,#0a0a0a)]')
...
<div class="dk-demo-shell">
    <div class="strip">
        <div class="strip-head">
            <span class="micro">// gesture burst</span>
            <span class="micro readout">{isLiked ? 'liked' : 'idle'}</span>
        </div>
        ...
        <div class="strip-foot">
            <span class="micro">press to toggle · hold streams the burst</span>
            <span class="micro">spring: 400</span>
        </div>
    </div>
</div>
