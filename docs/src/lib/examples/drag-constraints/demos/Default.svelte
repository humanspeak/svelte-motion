...
<div class="dk-demo-shell">
    <section class="drag-strip" aria-label="Drag constraints example">
        <div class="strip-head">
            <span class="micro">// drag constraints</span>
        ...
        <div class="strip-foot">
            <div class="chips">
                <span class="chip">elastic edge pull</span>
                <span class="chip">spring settle</span>
                <span class="chip">ref bounds</span>
            </div>
            <span class="micro">elastic: 0.32</span>
        </div>
    </section>
</div>
...
<style>
    ...
    :global(.drag-stage [aria-label='Draggable constrained card']) {
        position: relative;
        display: grid;
    ...
    :global(.drag-stage [aria-label='Draggable constrained card']::before) {
        content: '';
        position: absolute;
        inset: 8px;
